== Bus Timetable
<em>Epicodus Week 8 Day 1</em>

An Epicodus project to create a bus timetable using new Rails methods we recently learned in class.
...
* DONE As a bus rider, I want to view a bus line and see all of the buses that run on it and what time they arrive at each stop, so that I can pick one that fits my schedule.
